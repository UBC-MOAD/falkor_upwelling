...
\title{Investigating the Juan de Fuca Eddy \\ \Large{Generation and Interannual Water Properties} \\ 
\vspace{1cm} \large {2013 FALKOR Cruise data and NOAA/IOS data from 1970-2014} }

\author{Rob Irwin and Susan Allen}
...
The eddy is a cyclonic feature located off the entrance to Juan de Fuca strait. It spins up in March and lasts until September/October each year, and is centered just north of Spur Canyon -- west of the mouth of Juan de Fuca Strait. It is a center of upwelling, and this upwelled water transports deeper nutrient rich water to the shelf, and plays a significant role in increasing biological productivity in this region of the northeast Pacific.
...
Additionally, the way that the eddy is generated is under some dispute. While \cite{freeland1982topographically} suggest that it is a result of the Coriolis/pressure gradient imbalance causing an up-canyon flow, \cite{foreman2008modeling,macfadyen2010generation} suggest that it is generated as a result of enhanced upwelling along the Washington coast near Cape Flattery. The analysis in later chapters of the present text hopes to clarify this generation process using NOAA historical data.
...
\cite{hill1982aocean}, \cite{hill1982bocean}, \cite{hill1983ocean}
...
\subsection{\cite{flament2002state}; Spice as a Variable of Interest}
...
\subsection{\cite{macfadyen2010generation}; Generation of the Juan de Fuca Eddy}

This paper is a follow up to \cite{foreman2008modeling}. A similar numerical setup is used, however the forcing conditions change and the focus of the paper shifts slightly. This paper primarily highlights the role of variable wind forcing increasing the size of the JdFE. Storms appear to play a significant role in increasing the eddy size and moving it offshore from Cape Flattery. This paper does an excellent job introducing how the eddy develops and the structure and dynamics of the area around the eddy. 
